    ...
    <div class="container">
        <div class="row">
            <div class="order-2 order-md-1 col-md-8 order-md-2">
                ...
                <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet animi asperiores at
                    commodi facere,
    ...
    <div class="container">
        <div class="row">
            <div class="order-2 order-md-1 col-md-8 order-md-2">
                ...
                <p class="text-dark">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet animi asperiores at
                    commodi facere,
                    facilis harum ipsam maiores nisi non obcaecati officia quibusdam soluta sunt tenetur ullam veritatis
                    voluptate voluptatum!</p>
                <button type="button" class="btn btn-outline-info">More</button>
